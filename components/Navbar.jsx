...
const Navbar = () => {
  ...
  return (
    <div style={{ backgroundColor: `${color}` }} className='fixed left-0 top-0 z-10 w-full duration-300 ease-in'>
      <div className='mx-auto flex max-w-[1240px] items-center justify-between p-4 text-white'>
        <Link href={'/'}>
